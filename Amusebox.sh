...
expirydate = datetime.date(2025, 10, 12)
...
def hero():
    ...
    while y:
        ...
        print("Enter ", "Sapre:")  # Fixed Price to "Sapre"
        current = input()
        current = int(current)
        chalo()
...
if expirydate > today:
    ...
    if False:
        ...
        print("27 Feb 2022, 05:42 PM- 08:00 PM")
        print("Please play at the given time, and if you think it is an error contact the admin on telegram LOVE IS LIFE")
    ...
    print("*---------*----------*-------------*----------*")
    print("Your custom hack can be made on request.")
